 ...
 */
#define ATS_TYPE_SCB_RD			0x8ull	/* super child block ronly */
#define ATS_TYPE_SCB_RDWR		0x9ull	/* super child block rd/wr */

#define ATS_TYPE_SGL2_RD		0xcull	/* sglv2 ronly */
#define ATS_TYPE_SGL2_RDWR		0xdull	/* sglv2 rd/wr */
